...
public class RandomData2 {
	...
	private static final String FILENAME = "/home/nt/13April222.csv";
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 2; i < numberOfRows; i++) {
				...
				currentRow.append(String.valueOf(hnwcatgry[hnwint])+",");
